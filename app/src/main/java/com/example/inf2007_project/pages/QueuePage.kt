...
@Composable
fun QueuePage(modifier: Modifier = Modifier, navController : NavController, authViewModel: AuthViewModel, testViewModel: TestViewModel) {
    Scaffold(
        ...
        Column (
            ...
            Card (
                modifier = modifier
                    .fillMaxWidth()
                    .padding(8.dp), // Apply padding only to the Card itself
            ) {
                Column (
                    ...
                    Row {
                        Card(
                            ...
                            Text("Address")
                            Text("13 New Punggol Rd,")
                            Text("Singapore 829979")
                        }
